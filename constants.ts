...
export const APP_MODULES_CONFIG = [
  ...
  { 
    ...
    subModulesProject: [
        ...
        { type: 'link', name: 'Generar reporte diario', path: '/pm/daily-report', icon: PrintIcon, permission: 'projects.view' },
        { type: 'link', name: 'Histórico', path: '/pm/history', icon: ClipboardDocumentListIcon, permission: 'projects.viewHistory' },
    ] as SidebarItemConfig[],
    subModulesPOS: [] as SidebarItemConfig[],
    subModulesEcommerce: [] as SidebarItemConfig[],
    subModulesProjectClient: [] as SidebarItemConfig[],
