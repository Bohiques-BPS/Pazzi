...
import { WhatsappConfiguration } from '../../components/admin/WhatsappConfiguration';
...
export const AdminWhatsappPage: React.FC = () => <div className="space-y-6"><WhatsappConfiguration /></div>;
