...
const TEMPLATES: { id: ECommerceTemplate; name: string; desc: string; emoji: string }[] = [
    ...
    { id: 'Ofertas', name: 'Ofertas', desc: 'Estilo Temu: banners promocionales, grilla densa y precios grandes.', emoji: '🔥' },
    { id: 'Mayorista', name: 'Mayorista / B2B', desc: 'Estilo Alibaba: listado con proveedor, pedido mínimo y contacto.', emoji: '🏭' },
    { id: 'Autopartes', name: 'Autopartes + filtros', desc: 'Sidebar de filtros (categoría, precio) + grilla. Ideal para muchas piezas.', emoji: '🔧' },
