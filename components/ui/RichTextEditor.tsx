        ...
        <div className="w-full border border-neutral-300 dark:border-neutral-600 rounded-md shadow-sm focus-within:ring-2 focus-within:ring-primary dark:focus-within:ring-offset-neutral-800 focus-within:border-primary bg-white dark:bg-neutral-700">
            {!disabled && (
                <div className="flex items-center space-x-1 p-1.5 border-b border-neutral-200 dark:border-neutral-600 bg-neutral-50 dark:bg-neutral-800 rounded-t-md">
                    <RichTextEditorButton title={t('cmpx.rte.bold')} onMouseDown={(e) => handleCommand(e, 'bold')}>
                    ...
                    <RichTextEditorButton title={t('cmpx.rte.italic')} onMouseDown={(e) => handleCommand(e, 'italic')}>
                    ...
                    <RichTextEditorButton title={t('cmpx.rte.underline')} onMouseDown={(e) => handleCommand(e, 'underline')}>
                    ...
                    <RichTextEditorButton title={t('cmpx.rte.bullets')} onMouseDown={(e) => handleCommand(e, 'insertUnorderedList')}>
                     ...
                     <RichTextEditorButton title={t('cmpx.rte.numbered')} onMouseDown={(e) => handleCommand(e, 'insertOrderedList')}>
