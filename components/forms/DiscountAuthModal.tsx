...
export const DiscountAuthModal: React.FC<DiscountAuthModalProps> = ({ isOpen, onClose, onApply }) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Aplicar Descuento con Autorización" size="md">
            <div className="space-y-4">
                ...
                <div className="flex justify-end space-x-2 pt-4">
                    ...
                    <button type="button" onClick={handleApply} className={BUTTON_PRIMARY_SM_CLASSES}>Aplicar Descuento</button>
                </div>
            </div>
        </Modal>
    );
